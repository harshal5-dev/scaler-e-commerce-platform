...
import com.scaler.auth_server.models.Authorization;
import com.scaler.auth_server.repositories.AuthorizationRepository;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
  ...
  private OAuth2Authorization toObject(Authorization entity) {
    ...
    if (entity.getOidcIdTokenValue() != null) {
      OidcIdToken idToken =
          new OidcIdToken(entity.getOidcIdTokenValue(), entity.getOidcIdTokenIssuedAt(),
    ...
    if (entity.getUserCodeValue() != null) {
      OAuth2UserCode userCode = new OAuth2UserCode(entity.getUserCodeValue(),
          entity.getUserCodeIssuedAt(), entity.getUserCodeExpiresAt());
  ...
  private Authorization toEntity(OAuth2Authorization authorization) {
    ...
    setTokenValues(userCode, entity::setUserCodeValue, entity::setUserCodeIssuedAt,
        entity::setUserCodeExpiresAt, entity::setUserCodeMetadata);
