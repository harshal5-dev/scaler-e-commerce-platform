...
public class JpaRegisteredClientRepository implements RegisteredClientRepository {
  ...
  private Client toEntity(RegisteredClient registeredClient) {
    ...
    registeredClient.getAuthorizationGrantTypes().forEach(
        authorizationGrantType -> authorizationGrantTypes.add(authorizationGrantType.getValue()));
  ...
  private static ClientAuthenticationMethod resolveClientAuthenticationMethod(
    ...
    return new ClientAuthenticationMethod(clientAuthenticationMethod); // Custom client
